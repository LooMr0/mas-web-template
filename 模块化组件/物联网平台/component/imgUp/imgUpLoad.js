...
#cropper-popup{width:100%;height:auto}
...
.mas-img-item:nth-child(4n+1){margin-left:8px}
.mas-img-item{width:calc(100vw / 4 - 10px);height:calc(100vw / 4 - 8px);background:rgba(237,237,237,1);margin-right:8px;margin-top:8px;position:relative}
.mas-img-item>*{width:100%;height:100%;object-fit:cover}
.mas-delete{position:absolute;width:calc((100vw / 4 - 10px)/ 5);height:calc((100vw / 4 - 10px)/ 5);z-index:9;background:#fff;border-radius:50%;padding:5px;right:0;top:-5px}
.mas-delete>svg{width:100%;height:100%}
